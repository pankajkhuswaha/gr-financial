...
const ViewPage = () => {
  ...
  return (
    <>
      ...
      <div className="border col-8 p-4 shadow">
        ...
        <div className="d-flex justify-content-start align-items-center flex-wrap gap-4">
          <h5 className="col-12 col-xl-6">Customer Type : {data.customertype}</h5>
          <h5 className="col-12 col-xl-6">Handled By : {data.handleby}</h5>
          <h5 className="col-12 col-xl-6">Loan Type : {data.loantype}</h5>
          <h5 className="col-12 col-xl-6">Loan Amount : {data.loanAmount} rs.</h5>
          <h5 className="col-12 col-xl-6">Tennure Time : {data.tennuretime} Years</h5>
          <h5 className="col-12 col-xl-6">Date Of Disbursement : {data.dateOfDisburment}</h5>
          <h5 className="col-12 col-xl-6">Rate of Interest : {data.rateOfInterest} %</h5>
        </div>
        {data.firm[0].name && <div className="d-flex justify-content-start align-items-center flex-wrap">
          ...
          <p className="col-12 col-xl-6">Firm Address : {data.firm[0].adress}</p>
        </div> }
        {data.company[0].name  && <div className="d-flex justify-content-start align-items-center flex-wrap">
          <h4 className="col-12 my-4">Company Details</h4>
          <p className="col-12 col-xl-6">Company Name : {data.company[0].name}</p>
          <p className="col-12 col-xl-6">Company Type : {data.company[0].type}</p>
          <p className="col-12 col-xl-6">Company Address : {data.company[0].adress}</p>
        </div> }
            ...
            data?.cardetails?.map((it, i) => (
              <div key={i} className="col-12">
                ...
                <ul className=" list-unstyled px-4 py-2 border rounded shadow-sm">
                  ...
                  <li>
                    <span>Policy :</span> {it.propertyAddress}
                  </li>
                </ul>
              </div>
            ))
